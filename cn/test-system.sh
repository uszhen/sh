...
install_certbot() {
    ...
    # 下载并使脚本可执行
    curl -O https://raw.gitmirror.com/test-system.sh/main/auto_cert_renewal.sh
...
reverse_proxy() {
      ip_address
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/uszhen/nginx/main/reverse-proxy.conf
...
cluster_python3() {
    cd ~/cluster/
    curl -sS -O https://raw.githubusercontent.com/uszhen/python-for-vps/main/cluster/$py_task
...
EOF
  ...
  while true; do
    ...
    case $sub_choice in
      ...
      wget -O /home/web/nginx.conf https://raw.githubusercontent.com/uszhen/nginx/main/nginx10.conf
      wget -O /home/web/conf.d/default.conf https://raw.githubusercontent.com/uszhen/nginx/main/default10.conf
      default_server_ssl

      # 下载 docker-compose.yml 文件并进行替换
      wget -O /home/web/docker-compose.yml https://raw.githubusercontent.com/uszhen/docker/main/LNMP-docker-compose-10.yml
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/uszhen/nginx/main/wordpress.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/uszhen/nginx/main/discuz.com.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/uszhen/nginx/main/kdy.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf

      cd /home/web/html
      mkdir $yuming
      cd $yuming
      wget https://hub.gitmirror.com/https://github.com/kalcaddle/kodbox/archive/refs/tags/1.42.04.zip
      unzip -o 1.42.04.zip
      rm 1.42.04.zip
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/uszhen/nginx/main/maccms.com.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/uszhen/nginx/main/dujiaoka.com.conf
      ...
      mkdir $yuming
      cd $yuming
      wget https://hub.gitmirror.com/https://github.com/assimon/dujiaoka/releases/download/2.0.6/2.0.6-antibody.tar.gz && tar -zxvf 2.0.6-antibody.tar.gz && rm 2.0.6-antibody.tar.gz
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/uszhen/nginx/main/flarum.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/uszhen/nginx/main/typecho.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf

      cd /home/web/html
      mkdir $yuming
      cd $yuming
      wget -O latest.zip https://hub.gitmirror.com/https://github.com/typecho/typecho/releases/latest/download/typecho.zip
      unzip latest.zip
      rm latest.zip
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/uszhen/nginx/main/rewrite.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/uszhen/nginx/main/html.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
    ...
    33)
      ...
      cd ~
      wget -O ${useip}_beifen.sh https://raw.gitmirror.com/test-system.sh/main/beifen.sh > /dev/null 2>&1
    ...
    35)
      if [ -x "$(command -v fail2ban-client)" ] && [ -d "/etc/fail2ban" ]; then
          ...
          curl -sS -O https://raw.gitmirror.com/test-system.sh/main/sshd.local
          systemctl restart fail2ban
          docker rm -f nginx
          ...
          curl -sS -O https://raw.gitmirror.com/test-system.sh/main/nginx.local
          systemctl restart fail2ban
          sleep 1
          fail2ban-client status
          echo "防御程序已开启"
    ...
    36)
          while true; do
              ...
              case $sub_choice in
                  ...
                  # php调优
                  wget -O /home/www.conf https://raw.gitmirror.com/test-system.sh/main/www-1.conf
                  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
                  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
                  rm -rf /home/www.conf

                  # mysql调优
                  wget -O /home/custom_mysql_config.cnf https://raw.gitmirror.com/test-system.sh/main/custom_mysql_config-1.cnf
                  ...
                  # php调优
                  wget -O /home/www.conf https://raw.gitmirror.com/test-system.sh/main/www.conf
                  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
                  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
                  rm -rf /home/www.conf

                  # mysql调优
                  wget -O /home/custom_mysql_config.cnf https://raw.gitmirror.com/test-system.sh/main/custom_mysql_config.cnf
                  docker cp /home/custom_mysql_config.cnf mysql:/etc/mysql/conf.d/
                  rm -rf /home/custom_mysql_config.cnf
    ...
    while true; do
      ...
      case $sub_choice in
          ...
          12)
            ...
            docker_url="官网介绍: https://hub.gitmirror.com/https://github.com/whyour/qinglong"
            docker_use=""
            docker_passwd=""
            docker_app
            ...
            if docker inspect cloudreve &>/dev/null; then
                    ...
                    case $sub_choice in
                        1)
                            ...
                            curl -o /home/docker/cloud/docker-compose.yml https://raw.githubusercontent.com/uszhen/docker/main/cloudreve-docker-compose.yml
          ...
          14)
            ...
            docker_url="官网介绍: https://hub.gitmirror.com/https://github.com/icret/EasyImages2.0"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          16)
            ...
            docker_url="官网介绍: https://hub.gitmirror.com/https://github.com/wikihost-opensource/als"
            docker_use=""
            docker_passwd=""
            docker_app
          ...
          19)
            ...
            if docker inspect safeline-tengine &>/dev/null; then
                ...
                echo "官网介绍: https://hub.gitmirror.com/https://github.com/chaitin/safeline"
                echo ""
          ...
          21)
            ...
            docker_url="官网介绍: https://hub.gitmirror.com/https://github.com/coder/code-server"
            docker_use="sleep 3"
          ...
          22)
            ...
            docker_url="官网介绍: https://hub.gitmirror.com/https://github.com/louislam/uptime-kuma"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          23)
            ...
            docker_url="官网介绍: https://hub.gitmirror.com/https://github.com/usememos/memos"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
            ...
            if docker inspect "$docker_name" &>/dev/null; then
                ...
                case "$choice" in
                    [Yy])
                        ...
                        wget https://raw.gitmirror.com/test-system.sh/main/PandoraNext/config.json
                        wget https://raw.gitmirror.com/test-system.sh/main/PandoraNext/tokens.json
          ...
          28)
            ...
            docker_url="官网介绍: https://hub.gitmirror.com/https://github.com/librespeed/speedtest"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          31)
            ...
            docker_url="官网介绍: https://hub.gitmirror.com/https://github.com/Stirling-Tools/Stirling-PDF"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
            ...
            while true; do
                  ...
                  case $sub_choice in
                      1)
                        ...
                        wget -qO - https://raw.gitmirror.com/test-system.sh/main/archive.key | gpg --dearmor -o /usr/share/keyrings/xanmod-archive-keyring.gpg --yes

                        # 步骤3：添加存储库
                        echo 'deb [signed-by=/usr/share/keyrings/xanmod-archive-keyring.gpg] http://deb.xanmod.org releases main' | tee /etc/apt/sources.list.d/xanmod-release.list

                        # version=$(wget -q https://dl.xanmod.org/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
                        version=$(wget -q https://raw.gitmirror.com/test-system.sh/main/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
...
EOF
  ...
  p)
    cd ~
    curl -sS -O https://raw.gitmirror.com/test-system.sh/main/palworld.sh && chmod +x palworld.sh && ./palworld.sh
    exit
    ;;
  ...
  00)
    cd ~
    curl -sS -O https://raw.gitmirror.com/test-system.sh/main/update_log.sh && chmod +x update_log.sh && ./update_log.sh
    rm update_log.sh
    echo ""
