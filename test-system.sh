...
install_certbot() {
    ...
    # 下载并使脚本可执行
    curl -O https://raw.githubusercontent.com/uszhen/sh/main/auto_cert_renewal.sh
...
EOF
  ...
  while true; do
    ...
    case $sub_choice in
      ...
      mkdir $yuming
      cd $yuming
      wget https://github.com/test-system/Website_source_code/raw/main/Discuz_X3.5_SC_UTF8_20230520.zip
      ...
      cd /home/web/html/$yuming/template/ && wget https://github.com/test-system/Website_source_code/raw/main/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/$yuming/template/DYXS2.zip
      cp /home/web/html/$yuming/template/DYXS2/asset/admin/Dyxs2.php /home/web/html/$yuming/application/admin/controller
      cp /home/web/html/$yuming/template/DYXS2/asset/admin/dycms.html /home/web/html/$yuming/application/admin/view/system
      mv /home/web/html/$yuming/admin.php /home/web/html/$yuming/vip.php && wget -O /home/web/html/$yuming/application/extra/maccms.php https://raw.githubusercontent.com/uszhen/Website_source_code/main/maccms.php
    ...
    33)
      ...
      cd ~
      wget -O ${useip}_beifen.sh https://raw.githubusercontent.com/uszhen/sh/main/beifen.sh > /dev/null 2>&1
    ...
    35)
      if [ -x "$(command -v fail2ban-client)" ] && [ -d "/etc/fail2ban" ]; then
          ...
          curl -sS -O https://raw.githubusercontent.com/uszhen/sh/main/sshd.local
          systemctl restart fail2ban
          docker rm -f nginx
          ...
          curl -sS -O https://raw.githubusercontent.com/uszhen/sh/main/nginx.local
          systemctl restart fail2ban
          sleep 1
          fail2ban-client status
          echo "防御程序已开启"
    ...
    36)
          while true; do
              ...
              case $sub_choice in
                  ...
                  # php调优
                  wget -O /home/www.conf https://raw.githubusercontent.com/uszhen/sh/main/www-1.conf
                  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
                  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
                  rm -rf /home/www.conf

                  # mysql调优
                  wget -O /home/custom_mysql_config.cnf https://raw.githubusercontent.com/uszhen/sh/main/custom_mysql_config-1.cnf
                  ...
                  # php调优
                  wget -O /home/www.conf https://raw.githubusercontent.com/uszhen/sh/main/www.conf
                  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
                  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
                  rm -rf /home/www.conf

                  # mysql调优
                  wget -O /home/custom_mysql_config.cnf https://raw.githubusercontent.com/uszhen/sh/main/custom_mysql_config.cnf
                  docker cp /home/custom_mysql_config.cnf mysql:/etc/mysql/conf.d/
                  rm -rf /home/custom_mysql_config.cnf
            ...
            if docker inspect "$docker_name" &>/dev/null; then
                ...
                case "$choice" in
                    [Yy])
                        ...
                        wget https://raw.githubusercontent.com/uszhen/sh/main/PandoraNext/config.json
                        wget https://raw.githubusercontent.com/uszhen/sh/main/PandoraNext/tokens.json
            ...
            while true; do
                  ...
                  case $sub_choice in
                      1)
                        ...
                        local version=$(wget -q https://raw.githubusercontent.com/uszhen/sh/main/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
...
EOF
          ...
          21)
              ...
              while true; do
                  ...
                  case $host_dns in
                      1)
                          read -p "请输入新的解析记录 格式: 110.25.5.33 test-system.pro : " addhost
...
EOF
  ...
  p)
    cd ~
    curl -sS -O https://raw.githubusercontent.com/uszhen/sh/main/palworld.sh && chmod +x palworld.sh && ./palworld.sh
    exit
    ;;
  ...
  00)
    cd ~
    curl -sS -O https://raw.githubusercontent.com/uszhen/sh/main/update_log.sh && chmod +x update_log.sh && ./update_log.sh
    rm update_log.sh
    echo ""
    curl -sS -O https://raw.githubusercontent.com/uszhen/sh/main/test-system.sh && chmod +x test-system.sh
    echo "脚本已更新到最新版本！"
    break_end
    test-system
    ;;
